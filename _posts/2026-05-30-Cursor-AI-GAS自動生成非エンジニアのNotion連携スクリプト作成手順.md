---
layout: post
title: "CursorでGAS自動生成｜コード不要でNotion連携を作る手順"
date: 2026-05-30 09:10:06 +0900
description: "プログラミング未経験でもCursorにGASを自動生成させ、Notionとスプレッドシートを連携する手順を解説。一発で動くコードを出すプロンプトの書き方と、非エンジニアが必ず詰まる3つのポイントの回避策まで具体的に紹介します。"
tags:
